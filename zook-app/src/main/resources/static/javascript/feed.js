...
function getAllPosts() {
    ...
    xhttp.open('Post', 'http://localhost:9039/seeAllPost');
...
function DOMManipulation(posts) {
    ...
    //displays profile image in top left corner of posts    
        ...
        img1.setAttribute('src', 'http://localhost:9039/documents/presigned-url/${profilePic}');
    ...
    if(posts[i].postImage != null){
        ...
        img2.setAttribute('src', 'http://localhost:9039/documents/presigned-url/${postI}')
